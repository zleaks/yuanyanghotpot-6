...
void init_registry(void)
{
    ...
    static const WCHAR photoshop[] = {'S','o','f','t','w','a','r','e','\\',
                                       'A','d','o','b','e','\\','P','h','o','t','o','s','h','o','p','\\','7','.','0'};
    static const WCHAR photoshop_value[] = {'S','e','t','t','i','n','g','s','F','i','l','e','P','a','t','h'};
    ...
    static const struct unicode_str photoshop_name = { photoshop, sizeof(photoshop) };
    static const struct unicode_str photoshop_value_name = { photoshop_value, sizeof(photoshop_value) };
    ...
    {
        struct key *photoshop_path_key;
        if ((photoshop_path_key = create_key_recursive ( hkcu, &photoshop_name, current_time )))
        {
            delete_value(photoshop_path_key, &photoshop_value_name);
        }
    }
