...
#define IDC_NENO                        2000 /* 20210428 wanghg add for 配置默认应用 */
...
#define IDC_MIME_ASSCOMBO               1419
#define IDC_MIME_LIST                   1420
#define IDC_MIME_ADDDOC                 1421
#define IDC_MIME_REMOVEDOC              1422
/* 20210428 wanghg add for 配置默认应用 <-- */
