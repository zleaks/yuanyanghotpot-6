...
/*
 * start add by tongzhe, 20211208, 解决editplus程序中，点击“查找”->粘贴复制文字查找，软件卡死退出的问题
 */
#if defined __HOTPOT_EDITPLUS__
//        enumerate_strings(ac, pfx_filter);
#else
        enumerate_strings(ac, pfx_filter);
#endif // end __HOTPOT_EDITPLUS__
/*
 * end add by tongzhe, 20211208, 解决editplus程序中，点击“查找”->粘贴复制文字查找，软件卡死退出的问题
 */
    }
