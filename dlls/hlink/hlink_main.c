...
//add by xdl
/***********************************************************************
 *             HlinkCreateShortcutFromMoniker (HLINK.@)
 */
HRESULT WINAPI HlinkCreateShortcutFromMoniker(DWORD grfHLSHORTCUTF,
                                              IMoniker *pimkTarget,
                                              LPCWSTR pwzLocation,
                                              LPCWSTR pwzDir,
                                              LPCWSTR pwzFileName,
...
/***********************************************************************
 *             HlinkResolveShortcutToMoniker (HLINK.@)
 */
HRESULT WINAPI HlinkResolveShortcutToMoniker(void)
{
    FIXME("stub\n");
    return S_FALSE;
}
/***********************************************************************
 *             HlinkPreprocessMoniker (HLINK.@)
 */
HRESULT WINAPI HlinkPreprocessMoniker(
   LPBC     pibc,
   IMoniker *pimkIn,
   IMoniker **ppimkOut
)
...
/***********************************************************************
 *             HlinkSetSpecialReference (HLINK.@)
 */
HRESULT WINAPI HlinkSetSpecialReference(
    ULONG uReference,
