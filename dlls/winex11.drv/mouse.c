...
static void enable_xinput2(void)
{
    ...
    {
        //<yangxinruo><20210225><fix XInput minor support to 2.3,avoid X11 BadValue exception > modify begin
        // int major = 2, minor = 0;
        int major = 2, minor = 3;
        //<yangxinruo><20210225><fix XInput minor support to 2.3,avoid X11 BadValue exception > modify end
