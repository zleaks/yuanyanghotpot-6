...
extern void X11DRV_XDND_StatusEvent( HWND hWnd, XClientMessageEvent *event ) DECLSPEC_HIDDEN;
extern void X11DRV_XDND_FinishedEvent( HWND hWnd, XClientMessageEvent *event ) DECLSPEC_HIDDEN;
...
extern BOOL X11DRV_XDND_SelectionRequest(HWND hwnd, XEvent *xev) DECLSPEC_HIDDEN;
extern INT find_atom_in_buildin_format( INT id,Atom *supportAtoms ,INT max) DECLSPEC_HIDDEN;
extern BOOL export_buildIn_target( Display *display, Window win, Atom prop, Atom target, HANDLE handle ) DECLSPEC_HIDDEN;
...
enum x11drv_atoms
{
    ...
    XATOM_x_special_gnome_copied_files,
