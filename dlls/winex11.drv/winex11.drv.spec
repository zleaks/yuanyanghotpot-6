...
@ cdecl SetWindowSizeLimit(ptr ptr) X11DRV_SetWindowSizeLimit
...
@ cdecl RegisterHotKey(ptr long long) X11DRV_RegisterHotKey
@ cdecl UnregisterHotKey(ptr long long) X11DRV_UnregisterHotKey
#<yangxinruo><20200929><for global hotkey> add end
########################################################################
#gtk funcs
@ cdecl Gtk_GetOpenFileNameW(ptr) GTKDRV_Gtk_GetOpenFileNameW
@ cdecl Gtk_GetSaveFileNameW(ptr) GTKDRV_Gtk_GetSaveFileNameW
@ cdecl GTKSHBrowseForFolderW(ptr ptr) GTK_SHBrowseForFolderW
# WinTab32
...
#Ole32(Drag&Drop)
@ cdecl XDndDragInit(ptr) X11DRV_XDndDragInit
@ cdecl XDndDragDeinit(ptr) X11DRV_XDndDragDeinit
@ cdecl XDndPickUpTargetWindow(long long) X11DRV_XDndPickUpTargetWindow
@ cdecl XDndTargetEnter(long ptr) X11DRV_XDndTargetEnter
@ cdecl XDndTargetOver(long long long) X11DRV_XDndTargetOver
@ cdecl XDndTargetLeave(long) X11DRV_XDndTargetLeave
@ cdecl XDndTargetDrop(long long long ptr) X11DRV_XDndTargetDrop
...
#@ cdecl GTKGetSaveFileNameW(ptr) GTK_GetSaveFileNameW
#@ cdecl GTKGetOpenFileNameW(ptr) GTK_GetOpenFileNameW
#@ cdecl GTKSHBrowseForFolderW(ptr ptr) GTK_SHBrowseForFolderW
