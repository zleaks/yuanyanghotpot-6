...
/* X11drv functions */
extern void  (CDECL *pXDndDragInit)(HWND hwnddefault) DECLSPEC_HIDDEN;
extern void  (CDECL *pXDndDragDeinit)(HWND hwnddefault) DECLSPEC_HIDDEN;
extern int  (CDECL *pXDndPickUpTargetWindow)(LONG x,LONG y) DECLSPEC_HIDDEN;
extern int  (CDECL *pXDndTargetEnter)(INT window,IDataObject *pData) DECLSPEC_HIDDEN;
extern int  (CDECL *pXDndTargetOver)(INT window,LONG x,LONG y) DECLSPEC_HIDDEN;
extern void  (CDECL *pXDndTargetLeave)(INT window) DECLSPEC_HIDDEN;
extern int  (CDECL *pXDndTargetDrop)(INT window,LONG x,LONG y,IDataObject *pData) DECLSPEC_HIDDEN;
