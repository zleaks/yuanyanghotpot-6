...
void  (CDECL *pXDndDragInit)(HWND hwnddefault) = NULL;
void  (CDECL *pXDndDragDeinit)(HWND hwnddefault) = NULL;
int  (CDECL *pXDndPickUpTargetWindow)(LONG x,LONG y) = NULL;
int  (CDECL *pXDndTargetEnter)(INT window,IDataObject *pData) = NULL;
int  (CDECL *pXDndTargetOver)(INT window,LONG x,LONG y) = NULL;
void  (CDECL *pXDndTargetLeave)(INT window) = NULL;
int  (CDECL *pXDndTargetDrop)(INT window,LONG x,LONG y,IDataObject *pData) = NULL;
...
BOOL WINAPI DllMain(HINSTANCE hinstDLL, DWORD fdwReason, LPVOID reserved)
{
    ...
    case DLL_PROCESS_ATTACH:
        ...
        pXDndDragInit = (void *)GetProcAddress(module, "XDndDragInit");
        pXDndDragDeinit = (void *)GetProcAddress(module, "XDndDragDeinit");
        pXDndPickUpTargetWindow = (void *)GetProcAddress(module, "XDndPickUpTargetWindow");
        pXDndTargetEnter = (void *)GetProcAddress(module, "XDndTargetEnter");
        pXDndTargetOver = (void *)GetProcAddress(module, "XDndTargetOver");
        pXDndTargetLeave = (void *)GetProcAddress(module, "XDndTargetLeave");
        pXDndTargetDrop = (void *)GetProcAddress(module, "XDndTargetDrop");
	break;
