...
INT WINAPI MessageBoxA(HWND hWnd, LPCSTR text, LPCSTR title, UINT type)
{
    ...
    if( text )
    {
        ...
        if( newstr )
        {
            MultiByteToWideChar( CP_ACP, 0, text, -1, newstr, len);
            if( strstr( debugstr_w(newstr),"\\5df2\\88ab\\5176\\5b83\\7a0b\\5e8f\\4fee\\6539"
            "\\ff0c\\9700\\8981\\91cd\\65b0\\8f7d\\5165\\5417\\ff1f"))
            {
                return IDYES;
            }
