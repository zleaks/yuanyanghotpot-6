...
typedef struct tagUSER_DRIVER {
    ...
    void   (CDECL *pSetWindowSizeLimit)(HWND,MINMAXINFO*);
    //<yangxinruo><2020-09-27><for wechat minimum window size restriction not work> add end
    
	/*************<zyh><2021-10-14> <add gtk funcs>*********/
	BOOL   (CDECL *pGtk_GetOpenFileNameW)(void*);
	BOOL   (CDECL *pGtk_GetSaveFileNameW)(void*);
...
extern void SPY_GetUserProcessingMessage(LPINT result) DECLSPEC_HIDDEN;
#endif
