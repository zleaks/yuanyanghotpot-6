...
@ stdcall IsTopLevelWindow(long)
@ stdcall IsThreadDesktopComposited()
@ stdcall IsRButtonDown()
@ stdcall IsHwndMouseHovering(long)
#@ stdcall GetTopLevelWindow(long)
...
@ stdcall WindowFromPoint_internal(int64 long)
################################################################
##########GTK
@ stdcall Gtk_GetOpenFileNameW(ptr)
@ stdcall Gtk_GetSaveFileNameW(ptr)
