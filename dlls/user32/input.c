...
BOOL WINAPI UnregisterHotKey(HWND hwnd,INT id)
{
    ...
    //<yangxinruo><20201027><for wechat global hotkey detach from invalid hwnd> add begin
    if(!hwnd){
        TRACE_(keyboard)("YYYXXXRRR---> UnregisterHotKey with invail hwnd!!\n");
        return ret;
    }
    //<yangxinruo><20201027><for wechat global hotkey detach from invalid hwnd> add end
                                         ...
                                         DWORD dwTime)
{
    ...
    if(strcmp(class_name, "SkinDialog") == 0)
    {
        tracking_info.tme.dwFlags |= 0x01;
    }
#endif
