...
int get_FileManage_Style(DWORD flags) DECLSPEC_HIDDEN;
BOOL callSystemGetOpenFileNameW(LPOPENFILENAMEW pofn) DECLSPEC_HIDDEN;
BOOL callSystemGetSaveFileNameW(LPOPENFILENAMEW pofn) DECLSPEC_HIDDEN;
