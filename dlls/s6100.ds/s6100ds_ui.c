        ...
        case WM_NOTIFY:
            {
                ...
                switch (((NMHDR*)lParam)->code)
                {
                    case PSN_APPLY:
                        if (psn->lParam)
                        {
			    TRACE("%s:  psn->lParam = %ld \n", __func__, psn->lParam);
			    s6100_scanimage();
                            //SANE_Notify(MSG_XFERREADY);
                        }
                        break;
                    case PSN_QUERYCANCEL:
			TRACE("%s:  PSN_QUERYCANCEL = %d \n", __func__, PSN_QUERYCANCEL);
			s6100_endScan();
...
{
	flag_changed |= S6100_CHECK1_FLAG;
...
{
	flag_changed |= S6100_CHECK2_FLAG;
...
void s6100_pageButtonClicked(HWND dialog)
{
	...
	switch (selection)
	{
		case S6100_COMBO_INDEX0:
			ret = s6100_setCapability("mode", "Lineart");
			TRACE("s6100_setCapability: mode, Lineart,  ret = %d \n", ret);			
			break;
		case S6100_COMBO_INDEX1:
			ret = s6100_setCapability("mode", "Gray");
			TRACE("s6100_setCapability: mode, Gray,  ret = %d \n", ret);			
			break;		
		case S6100_COMBO_INDEX2:
			ret = s6100_setCapability("mode", "Color");
			TRACE("s6100_setCapability: mode, Color,  ret = %d \n", ret);			
			break;
	}
	...
	{
		ret = s6100_setCapability("resolution", value_buffer);
		TRACE("s6100_setCapability: resolution, %s,  ret = %d \n", value_buffer, ret);
	}
	...
	{
		case S6100_COMBO_INDEX0:
			ret = s6100_setCapability("source", "Automatic");
			TRACE("s6100_setCapability: source, Automatic,  ret = %d \n", ret);			
			break;
		case S6100_COMBO_INDEX1:
			ret = s6100_setCapability("source", "Flatbed");
			TRACE("s6100_setCapability: source, Flatbed,  ret = %d \n", ret);			
			break;		
		case S6100_COMBO_INDEX2:
			ret = s6100_setCapability("source", "ADF Front");
			TRACE("s6100_setCapability: source, ADF Front,  ret = %d \n", ret);			
			break;
		case S6100_COMBO_INDEX3:
			ret = s6100_setCapability("source", "ADF Back");
			TRACE("s6100_setCapability: source, ADF Back,  ret = %d \n", ret);			
			break;
		case S6100_COMBO_INDEX4:
			ret = s6100_setCapability("source", "ADF Duplex");
			TRACE("s6100_setCapability: source, ADF Duplex,  ret = %d \n", ret);			
			break;				
	}
	...
	{
		case S6100_COMBO_INDEX0:
			ret = s6100_setCapability("rotate", "None");
			TRACE("s6100_setCapability: rotate, None,  ret = %d \n", ret);			
			break;
		case S6100_COMBO_INDEX1:
			ret = s6100_setCapability("rotate", "90");
			TRACE("s6100_setCapability: rotate, 90,  ret = %d \n", ret);			
			break;		
		case S6100_COMBO_INDEX2:
			ret = s6100_setCapability("rotate", "180");
			TRACE("s6100_setCapability: rotate, 180,  ret = %d \n", ret);			
			break;
		case S6100_COMBO_INDEX3:
			ret = s6100_setCapability("rotate", "270");
			TRACE("s6100_setCapability: rotate, 270,  ret = %d \n", ret);			
			break;
		case S6100_COMBO_INDEX4:
			ret = s6100_setCapability("rotate", "Auto Orientation");
			TRACE("s6100_setCapability: rotate, Auto Orientation,  ret = %d \n", ret);
			selection = SendDlgItemMessageW(dialog, IDC_COMBO5, CB_GETCURSEL, 0, 0);
			switch (selection)
			{
				case S6100_COMBO_INDEX0:
					ret = s6100_setCapability("auto-orientation-mode", "Quick");
					TRACE("s6100_setCapability: auto-orientation-mode, Quick,  ret = %d \n", ret);
					break;
				case S6100_COMBO_INDEX1:
					ret = s6100_setCapability("auto-orientation-mode", "Full text");
					TRACE("s6100_setCapability: auto-orientation-mode, Full text,  ret = %d \n", ret);
					break;
				case S6100_COMBO_INDEX2:
					ret = s6100_setCapability("auto-orientation-mode", "Complexity");
					TRACE("s6100_setCapability: auto-orientation-mode, Complexity,  ret = %d \n", ret);
					break;
			}
			break;				
	}

    selection = SendDlgItemMessageW(dialog, IDC_COMBO6, CB_GETCURSEL, 0, 0);
	switch (selection)
	{
		case S6100_COMBO_INDEX0:
			strcpy(strpicexname, ".bmp");
			break;
		case S6100_COMBO_INDEX1:
			strcpy(strpicexname, ".jpg");
			break;		
		case S6100_COMBO_INDEX2:
			strcpy(strpicexname, ".tif");
			break;
	}
	TRACE("s6100_setCapability: image, value = %s \n", strpicexname); 		
	
	s6100_setLight(dialog, IDC_EDIT1, "brightness");
	s6100_setLight(dialog, IDC_EDIT2, "contrast");

	if ((flag_changed & (S6100_CHECK1_FLAG)) != 0)
	{
		if (IsDlgButtonChecked(dialog, IDC_CHECK1) == BST_CHECKED) 
		{
			ret = s6100_setCapability("autocropdeskew", "1");
			TRACE("s6100_setCapability: autocropdeskew true, ret = %d \n", ret);
		} 
		else if (IsDlgButtonChecked(dialog, IDC_CHECK1) == BST_UNCHECKED)
		{
			ret = s6100_setCapability("autocropdeskew", "0");
			TRACE("s6100_setCapability: autocropdeskew false, ret = %d \n", ret);
			s6100_setPaper(dialog, IDC_EDIT3, "tl-x");
			s6100_setPaper(dialog, IDC_EDIT4, "tl-y");
		}
	}

	if ((flag_changed & (S6100_CHECK2_FLAG)) != 0)
	{
		if (IsDlgButtonChecked(dialog, IDC_CHECK2) == BST_CHECKED) 
		{
			int get_edit_value = 999;
		
			ret = s6100_setCapability("blank-page-removal", "1");
			TRACE("s6100_setCapability: blank-page-removal true, ret = %d \n", ret);

			SendDlgItemMessageA(dialog, IDC_EDIT5, WM_GETTEXT, sizeof(value_buffer), (LPARAM)value_buffer);
			TRACE("%s: blank-page-threshold value = %s\n", __func__, value_buffer);
			get_edit_value = atoi(value_buffer);
			if (get_edit_value >= 0 && get_edit_value <= 100)
			{
				ret = s6100_setCapability("blank-page-threshold", value_buffer);
				TRACE("s6100_setCapability: blank-page-threshold ret = %d \n", ret);
			}
	    } 
		else if (IsDlgButtonChecked(dialog, IDC_CHECK2) == BST_UNCHECKED) 
		{
			ret = s6100_setCapability("blank-page-removal", "0");
			TRACE("s6100_setCapability: blank-page-removal false, ret = %d \n", ret);
	    }
	}
...
void s6100_setLight(HWND dialog, INT ctrl, const char * strCap)
{
	TW_UINT16 ret = -1;
	int get_edit_value = 999;
	char value_buffer[256];

    SendDlgItemMessageA(dialog, ctrl, WM_GETTEXT, sizeof(value_buffer), (LPARAM)value_buffer);
	if(strcmp(value_buffer, "") == 0)
	{
		return;
	}
	get_edit_value = atoi(value_buffer);
	if( get_edit_value >= -100 && get_edit_value <= 100)
	{
		ret = s6100_setCapability(strCap, value_buffer);
		TRACE("s6100_setCapability: %s, %s,  ret = %d \n", strCap, value_buffer, ret);		
	}
	else if(get_edit_value < -100)
	{
		ret = s6100_setCapability(strCap, "-100");
		TRACE("s6100_setCapability: %s, -100,  ret = %d \n", strCap, ret);		
	}
	else if(get_edit_value > 100)
	{
		ret = s6100_setCapability(strCap, "100");
	...
	{
		TRACE("%s: what the hell you input??? value_buffer = %s\n", __func__, value_buffer);
	}

	return;
}

void s6100_setPaper(HWND dialog, INT ctrl, const char * strCap)
{
	TW_UINT16 ret = -1;
	int get_edit_value = 999;
	char value_buffer[256];
	...
	TRACE("%s: strCap = %s, value_buffer = %s\n", __func__, strCap, value_buffer);
	get_edit_value = atoi(value_buffer);
	if (get_edit_value > 0)
	{
		ret = s6100_setCapability(strCap, value_buffer);
