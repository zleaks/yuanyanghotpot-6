...
/*start add by zhuyi, 20210928, 修正无法dbg的问题*/
        static const WCHAR  path_zy[] = {
            'b','i','n',':',
            's','b','i','n',':',
            '/','u','s','r','/','b','i','n',':',
            '/','u','s','r','/','s','b','i','n',':',
            '/','u','s','r','/','l','o','c','a','l','/','b','i','n',':',
            '/','u','s','r','/','l','o','c','a','l','/','s','b','i','n',
            '\0'};
        ret = search_unix_path(filename, path_zy, elf_load_file_cb, &load_elf)
            || search_dll_path(pcs, filename, elf_load_file_cb, &load_elf);
/*end add by zhuyi, 20210928, 修正无法dbg的问题*/
    }
